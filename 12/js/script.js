  ...
  handleAnimations() {
    ...
    if (isPrizesPage) {
      setTimeout(() => {
        ...
        _game__WEBPACK_IMPORTED_MODULE_3__["casesCounter"].runCounter();
      }, 5000);

      setTimeout(() => {
        codesDescElement.classList.add(`active`);
        _game__WEBPACK_IMPORTED_MODULE_3__["codesCounter"].runCounter();
      }, 6000);
    } else {
      casesDescElement.classList.remove(`active`);
      codesDescElement.classList.remove(`active`);

      _game__WEBPACK_IMPORTED_MODULE_3__["casesCounter"].resetCounter();
      _game__WEBPACK_IMPORTED_MODULE_3__["codesCounter"].resetCounter();
    }

    if (isGamePage) {
      _game__WEBPACK_IMPORTED_MODULE_3__["gameTimer"].runTimer();
    } else {
      _game__WEBPACK_IMPORTED_MODULE_3__["gameTimer"].resetTimer();
    }
  }
}
...
/*!***********************************!*\
  !*** ./source/js/modules/game.js ***!
  \***********************************/
/*! exports provided: gameTimer, casesCounter, codesCounter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "gameTimer", function() { return gameTimer; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "casesCounter", function() { return casesCounter; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "codesCounter", function() { return codesCounter; });
class GameTimer {
  constructor(fps) {
...
/***/ "./source/js/modules/initialise.js":
/*!*****************************************!*\
  !*** ./source/js/modules/initialise.js ***!
  \*****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_initialise__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/initialise */ "./source/js/modules/initialise.js");
...
// init modules
Object(_modules_initialise__WEBPACK_IMPORTED_MODULE_0__["default"])();
